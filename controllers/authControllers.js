...
const createSendToken = (res, user, statusCode) => {
    ...
    if (process.env.JWT_COOKIES_EXPIRES_IN === 'production') cookieOptions.secure = true;
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
    ...
    let message = `Forgot your password. Submit patch request with your new paassword and password confirm to: ${resetURL}.
